...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [OS_WIN_LAYOUT] = LAYOUT(
        ...
        TD(DNC_ESC_LS),         KC_LALT,        _______,        MO(NAV_LAYOUT),         MO(FKEYS_LAYOUT),   TD(DNC_BACKSPACE),            TD(DNC_BACKSPACE),      MO(FKEYS_LAYOUT), MO(NAV_LAYOUT), KC_TRANSPARENT, KC_RALT, KC_LGUI,
    ...
    [NAV_LAYOUT] = LAYOUT(
        ...
        _______, KC_PGUP, _______, KC_UP,   _______, _______,                      _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  _______,
        _______, KC_PGDN, TD(DNC_LEFT), KC_DOWN, TD(DNC_RIGHT), C(KC_C),           _______, TD(DNC_LEFT), KC_UP, KC_DOWN, TD(DNC_RIGHT), _______,
        _______, _______, _______, _______, _______, _______,                      _______, _______, _______, _______, _______, _______,
