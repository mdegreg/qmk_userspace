...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [OS_WIN_LAYOUT] = LAYOUT(
        ...
        KC_CAPS_LOCK,           KC_A,           KC_S,           KC_D,                   KC_F,               KC_G,                         KC_H,     KC_J,  KC_K,    KC_L,        KC_SCLN,     KC_VOLD,
        KC_LSFT,                KC_Z,           TD(DNC_XCUT),   TD(DNC_COPY),           TD(DNC_CPS),        KC_B,                         KC_SLASH, KC_N,  KC_M,    KC_COMMA,    KC_DOT,      KC_QUOTE,
    ...
    [FKEYS_LAYOUT] = LAYOUT(
        _______, _______, KC_QUOTE,     KC_DOT,  KC_COMMA,   KC_BSLS,             KC_SLASH,    KC_EQUAL, KC_MINUS,   KC_QUOTE,  _______, _______,
