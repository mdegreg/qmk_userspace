...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [OS_WIN_LAYOUT] = LAYOUT_moonlander(
    ...
    KC_GRAVE,           KC_Q,    KC_W,         KC_E,                 KC_R,                   KC_T, KC_DOT,             KC_EQUAL,                KC_Y,                   KC_U,           KC_I,     KC_O,     KC_P,    KC_VOLU,
    KC_CAPS_LOCK,       KC_A,    KC_S,         KC_D,                 KC_F,                   KC_G, KC_TAB,             KC_MINUS,                KC_H,                   KC_J,           KC_K,     KC_L,     KC_SCLN, KC_VOLD,
  ...
  [GAMINGFAST_LAYOUT] = LAYOUT_moonlander(
    ...
    _______,  _______, _______, _______,     _______, KC_T,    KC_7,                 _______, _______, _______, _______, _______, _______, _______,
  ...
  [NUMKEYS_GAMING] = LAYOUT_moonlander(
      // phone-style numpad plus arrowkey layer
    _______, KC_1,    KC_2,    KC_3,    KC_4,     KC_5, KC_6,                   _______, _______, _______, _______, _______, _______, _______,
    _______, _______, KC_UP,   KC_7,    KC_8,     KC_9, KC_0,                   _______, _______, _______, _______, _______, _______, _______,
