...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [OS_WIN_LAYOUT] = LAYOUT_moonlander(
    ...
    TT(NUMKEYS_LAYOUT), KC_LALT,        KC_TRANSPARENT, TT(NAV_LAYOUT),     MO(FKEYS_LAYOUT),           TD(DNC_BACKSPACE),                  TD(DNC_BACKSPACE),      MO(FKEYS_LAYOUT), LT(NAV_LAYOUT, KC_LBRC), KC_RBRC, KC_RALT, KC_LGUI,
  ...
  [NAV_LAYOUT] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT,         S(KC_1),        S(KC_LBRC),     KC_LBRC,        S(KC_9),                S(KC_COMMA),     KC_TRANSPARENT,        KC_TRANSPARENT, S(KC_DOT),      S(KC_0),        KC_RBRC,        S(KC_RBRC),     S(KC_0),         KC_TRANSPARENT,
    KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_DOT,         KC_COMMA,               KC_BSLS,         KC_TRANSPARENT,        KC_TRANSPARENT, KC_SLASH,       KC_EQUAL, 		KC_MINUS, 		KC_TRANSPARENT, KC_TRANSPARENT,  KC_TRANSPARENT,
    KC_TRANSPARENT,         S(KC_1),        S(KC_2),        S(KC_3),        S(KC_4),                S(KC_5),                                S(KC_6),        S(KC_7),        S(KC_8),        S(KC_9),        S(KC_0),         KC_TRANSPARENT,
    KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, S(KC_MINUS),                             KC_TRANSPARENT,        KC_TRANSPARENT,                 KC_SCLN,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,  KC_TRANSPARENT,
