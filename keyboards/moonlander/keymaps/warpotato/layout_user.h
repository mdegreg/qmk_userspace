...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [OS_WIN_LAYOUT] = LAYOUT_moonlander(
    ...
    TT(NUMKEYS_LAYOUT), KC_LALT,        KC_TRANSPARENT, MO(NAV_LAYOUT),     MO(FKEYS_LAYOUT),           TD(DNC_BACKSPACE),                  TD(DNC_BACKSPACE),      MO(FKEYS_LAYOUT), MO(NAV_LAYOUT), KC_TRANSPARENT, KC_RALT, KC_LGUI,
  ...
  [NAV_LAYOUT] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT,         S(KC_1),        S(KC_LBRC),     S(KC_9),        KC_LBRC,                S(KC_COMMA),     KC_TRANSPARENT,        KC_TRANSPARENT, S(KC_DOT),        KC_RBRC, S(KC_0),        S(KC_RBRC),     S(KC_0),         KC_TRANSPARENT,
    KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_COMMA,         KC_DOT,               KC_BSLS,         KC_TRANSPARENT,        KC_TRANSPARENT, KC_SLASH,       KC_MINUS, 		KC_EQUAL, 		KC_TRANSPARENT, KC_TRANSPARENT,  KC_TRANSPARENT,
